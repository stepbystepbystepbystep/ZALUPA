...
public class GameController : MonoBehaviour
{
    ...
    private float camMoveToYPositon, camMoveSpeed = 2f;
    ...
    private void Start()
    {
        ...
        scoreTxt.text = "<size=37><color=red>Best:</color></size> " + PlayerPrefs.GetInt("score") + " <size=33><color=white>Now:</color></size> 0";

        mainCam = Camera.main.transform;
        camMoveToYPositon = 5.9f + nowCube.y - 1f;
    ...
    private void Update() 
    {
        ...
        if (!IsLose && allCubesRb.velocity.magnitude > 0.1f) 
        {
            ...
            new Vector3(mainCam.localPosition.x, camMoveToYPositon, mainCam.localPosition.z),
    ...
    private void MoveCameraChangeBg()
    {
        ...
        scoreTxt.text = "<size=37><color=red>Best:</color></size> " + PlayerPrefs.GetInt("score") + " <size=33><color=white>Now:</color></size>" + maxY;
